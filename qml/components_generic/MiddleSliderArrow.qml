...
T.Slider {
    ...
    background: Rectangle {
        ...
        Rectangle {
            property real ccc: (control.visualPosition * control.availableWidth)
            x: ((ccc < (control.availableWidth / 2)) ? ccc : (control.availableWidth / 2))
            width: ((ccc < (control.availableWidth / 2)) ? (control.availableWidth / 2) - ccc : ccc - (control.availableWidth / 2))
