...
MediaCardBackground {
    ...
    implicitWidth: 360
    implicitHeight: control.mediaHeight + bodyColumn.implicitHeight
    ...
    property real mediaHeight: 155 // control.height * 0.5

    property int gradientType: GradientPresets.Linear
    property var gradientStops: GradientPresets.grape
    property real gradientAngle: 115
    ...
    Column {
        ...
        anchors.right: parent.right
        anchors.top: parent.top
        anchors.topMargin: control.mediaHeight
